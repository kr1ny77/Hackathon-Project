#!/bin/bash
# ============================================================
# FINAL FIX — One script. Upload to VM and run: bash fix-final.sh
# Fixes:
#   1. endpoints.py — missing 'select' import + services.Medicine -> Medicine
#   2. rebuilds backend image with all fixes
...
echo "============================================"
echo "  FINAL FIX — Medicine Reminder"
echo "============================================"

# ===================== FIX: backend/app/api/endpoints.py =====================
...
async def get_active_schedules_for_time(
    hour: int, minute: int, db: AsyncSession = Depends(get_db),
):
...
echo "[1/6] endpoints.py fixed"

# ===================== FIX: bot/app/handlers/schedule.py =====================
...
echo "[2/6] schedule.py fixed"

# ===================== FIX: bot/app/handlers/start.py =====================
...
echo "[3/6] start.py fixed"

# ===================== FIX: bot/app/handlers/medicine.py =====================
...
echo "[4/6] medicine.py fixed"

# ===================== FIX: bot/app/handlers/intake.py =====================
...
echo "[5/6] intake.py fixed"

# ===================== FIX: bot/app/handlers/router.py =====================
...
echo "  /start  -> menu buttons"
echo "  /add    -> add medicine"
